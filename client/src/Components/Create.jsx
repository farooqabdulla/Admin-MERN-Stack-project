...
const Create = () => {
  ...
  let but1 = () => {
    ...
    axios.post('http://localhost:3000/CreateEmployee',{name,email,phone,designation,gender,course,image,date:currentDate})
        ...
        <Card sx={{ width: '85%', m: 'auto', mt: '5vh' }}>
          <CardContent sx={{ p: '6vh' }}>
            <form action="">
              ...
              <Stack>
                <Button sx={{ mt: '4vh', mb: '4vh' }} onClick={but1} variant='contained' type='submit'>Submit</Button>
              </Stack>
            </form>
          </CardContent>
        </Card>
